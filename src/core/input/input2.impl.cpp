...
bool Input2::Impl::keyDown(KeyboardKey key) const
{
    return m_keyboardKeysDown[getKey(key)];
}

bool Input2::Impl::keyUp(KeyboardKey key) const
{
    return !m_keyboardKeysDown[getKey(key)];
}

bool Input2::Impl::keyPress(KeyboardKey key) const
{
    return m_keyboardKeysPress[getKey(key)];
}

bool Input2::Impl::mouseDown(MouseButton button) const
{
    return m_mouseButtonsDown[getButton(button)];
}

bool Input2::Impl::mouseUp(MouseButton button) const
{
    return !m_mouseButtonsDown[getButton(button)];
}

bool Input2::Impl::mouseClick(MouseButton button) const
{
    return m_mouseButtonsClick[getButton(button)];
}

bool Input2::Impl::mouseMove() const
{
    return m_mouseMove;
}
...
bool Input2::Impl::quit() const
{
    return m_quit;
}

int Input2::Impl::getKey(KeyboardKey key) const
{
    switch (key)
    {
...
int Input2::Impl::getButton(MouseButton button) const
{
    switch (button)
    {
